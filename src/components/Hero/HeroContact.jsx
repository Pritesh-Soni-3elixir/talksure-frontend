        ...
        <div className="row justify-content-center pt-3 mt-3">
          <div className="col-xl-6 col-lg-7 col-md-8 col-sm-10 text-center">
            ...
            <div className="d-flex justify-content-center">
              <a href="#" className="btn btn-icon btn-secondary btn-facebook rounded-circle mx-2">
                <i className="bx bxl-facebook" />
              </a>
              <a href="#" className="btn btn-icon btn-secondary btn-instagram rounded-circle mx-2">
                <i className="bx bxl-instagram" />
              </a>
              <a href="#" className="btn btn-icon btn-secondary btn-google rounded-circle mx-2">
                <i className="bx bxl-google" />
              </a>
              <a href="#" className="btn btn-icon btn-secondary btn-twitter rounded-circle mx-2">
